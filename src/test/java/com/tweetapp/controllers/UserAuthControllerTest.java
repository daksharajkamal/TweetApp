...
public class UserAuthControllerTest {
	...
	public void testSubscribeClient() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/tweets/register")
				.contentType(MediaType.APPLICATION_JSON).content(convertToJson(userModel))
	...
	public void testAuthenticateClientWithException() throws Exception {
		...
		}).when(authenticationManager).authenticate(new UsernamePasswordAuthenticationToken("Test", "TestPassword"));

		final RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/tweets/login")
				.content(convertToJson(authenticationRequest)).contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
