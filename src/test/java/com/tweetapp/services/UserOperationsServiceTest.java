...
public class UserOperationsServiceTest {
	...
	public void testChangePassword() throws PasswordMisMatchException {
		...
		final UserModel model = UserModel.builder().username("henry@yahoo.com").password("newPassword")
				.firstName("henry").lastName("ic").contactNum("1234567890").email("henry@yahoo.com").build();
